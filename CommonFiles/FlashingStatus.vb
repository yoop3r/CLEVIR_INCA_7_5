...
Public Class FlashingStatus
    ...
    Private Sub HandleImportSoftwareAndCals()
        ...
        'InitForm.RadioButton1 is the DEVELOPMENT button on the Init Screen...
        InitForm.RadioButton1.Checked = True 'If Import Sofware and Cals Import button has been pressed, this indicates use in a DEVELOPMENT vehicle...
