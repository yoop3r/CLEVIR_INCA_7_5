...
Public Class SyncScript
    ...
    Sub Main()
        Dim userChoice As MsgBoxResult = MsgBox("Start Data Synchronization Script?", CType(MsgBoxStyle.YesNo + MsgBoxStyle.Question, MsgBoxStyle), "Start Script")
    ...
    Sub HandleMissingConfig(configFilePath As String)
        ...
        Dim userChoice As MsgBoxResult = MsgBox(msg, CType(MsgBoxStyle.YesNo + MsgBoxStyle.Question, MsgBoxStyle), "Config Missing")
