...
Public Class GM_INCA_CommClass : Inherits MarshalByRefObject
    ...
    Public Function RegisterSignals(
        ...
        If incomingSignals.Length > 0 AndAlso enabledCameraPositions.Count > 0 Then
            Dim filteredSignals As New List(Of IGM_INCA_Comm.DeviceRasterSignalStatus)(incomingSignals.Length)
            Dim skippedCameraMismatchCount As Integer = 0
            ...
            If skippedCameraMismatchCount > 0 Then
                HandleUserMessageLogging("COMM", $"RegisterSignals: Camera source override skipped {skippedCameraMismatchCount} mismatched camera timecode signal(s); processing {filteredSignals.Count} of {incomingSignals.Length} incoming.")
            End If

            incomingSignals = filteredSignals.ToArray()
        End If
                ...
                If cacheValid Then
                    ...
                    If cachedKeys IsNot Nothing AndAlso cachedKeys.Count > 0 Then
                        ...
                        If activeLabels IsNot Nothing AndAlso activeLabels.Length > 0 Then
                            ...
                            Dim signalsToSubscribe() As IGM_INCA_Comm.DeviceRasterSignalStatus = If(allIncomingActive, incomingSignals, missingSignals.ToArray())
